...
<body>
    ...
    <div class="container cont">
        ...
        <div class="row col-lg-8 col-md-8 col-sm-12 mb-3">
            <form method="get" action="" style="margin-top:-20px;font-family: Times New Roman, Times, serif;">
            <label class="font-weight-bolder">Select Blood Group:</label>
               <select name="search" class="form-control" style="width: 380px;">
               ...
               <input type="submit" name="submit" class="btn btn-primary" value="search" style="margin-left:180px">
           </form>
        </div>

        <table class="table table-responsive table-striped rounded mb-5" style="background-color: whitesmoke;font-family: Times New Roman, Times, serif;">
